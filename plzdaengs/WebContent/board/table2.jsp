...
%>
  ...
  $(document).ready(function() {
	  //
	//  var serviceKey = encodeURIComponent('');

	  $.ajax({
			url : "<%=root%>/BoardController",
			type : "get",			//formì type ë¹ì·íë¤
			dataType : "xml",
			data : "cmd=strayDog",
			timeout : 30000,
			cache:false,
			success:function(xml){	// ì½ë°±í¨ì : ì±ê³µ  
			}
		});
 ...
 <body>
    ...
    <div class="d-flex align-items-stretch" id="document">
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-4" id="contents">
          <section class="py-5">
              <div class="col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                   ...
                   <div class="form-group row">
                    <label class="col-md-3 form-control-label">날짜</label>
                  ...
                  <div class="form-group row">
                    <label class="col-md-2 form-control-label">품종</label>
                       <div class="col-md-3 select mb-3">
                         <select name="account" class="form-control">
                           <option>option 1</option>
                           <option>option 2</option>
